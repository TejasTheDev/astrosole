...
import love_2 from '../../images/love_2.png'
...
import Remidies from '../../images/Remidies.jpg'
import Kids from '../../images/Kids.png'
import Parents from '../../images/Parents.png'
import Vedic_Astrology from '../../images/Vedic Astrology.png'


const AdminAstroCategory = () => {
  return (
                        ...
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                                ...
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                    ...
                                    <td class="py-4 px-6 text-sm">
                                        <img src={Vedic_Astrology} alt="Vedic_Astrology" />
                                    </td>
                                    <td class="py-4 px-6 text-sm">
                                        Active  
                                    </td>
...
export default AdminAstroCategory